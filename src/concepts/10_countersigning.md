...
Without a global ledger, there's no need for global consensus in a Holochain application. However, it's sometimes useful for two or more parties to reach a 'local consensus', a shared perspective on their individual source chains. Countersigning automates this process
</div>
...
A lot of human interactions involve formal transactions of one sort of another. Purchases, title transfers, legal agreements, and even chess moves require parties to get an up-to-date, accurate picture of their counterparties' world and make a decision on it before anything changes. In a distributed system, this is hard. Holochain offers countersigning as a way for two or more participants to lock their source chains at a particular moment until they finish the transaction.</div>
