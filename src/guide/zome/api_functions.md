...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.entry_address.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.debug.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.call.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.sign.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.encrypt.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.decrypt.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.commit_entry.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.update_entry.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.remove_entry.html)
...
- [View get_entry in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_entry.html)
- [View get_entry_initial in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_entry_initial.html)
- [View get_entry_history in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_entry_history.html)
- [View get_entry_result in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_entry_result.html)
...
- [View get_links in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_links.html)
- [View get_links_and_load in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_links_and_load.html)
- [View get_links_result in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_links_result.html)
- [View get_links_with_options in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.get_links_with_options.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.link_entries.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.query.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.send.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.commit_capability_grant.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.emit_signal.html)
...
[View it in the Rust HDK](https://docs.rs/hdk/latest/hdk/api/fn.entry_type_properties.html)
