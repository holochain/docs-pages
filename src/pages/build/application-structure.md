...
A hApp can optionally include a web-based UI that [supporting Holochain runtimes](/get-started/3-packaging-and-distribution/#runtimes) can serve to the user.
