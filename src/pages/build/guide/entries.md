...
It's up to you to decide whether two updates on the same entry or action are conflicts. If your use case allows branching edits similar to Git, then conflicts aren't an issue.

But if your use case needs to determine a single canonical version of a resource, you'll need to decide on a conflict resolution strategy to use at retrieval time.
