...
* It also [returns the status of the chain](/build/getting-an-agents-status/) (empty, valid, invalid, or forked) along with any collected [**warrants**](/resources/glossary/#warrant), and
