...
To spin up a conductor and create a hApp instance for a single agent, call [`scenario.addPlayerWithApp`](https://github.com/holochain-open-dev/tryorama/blob/main/docs/tryorama.scenario.addplayerwithapp.md), passing it an [`AppWithOptions`](https://github.com/holochain-open-dev/tryorama/blob/main/docs/tryorama.appwithoptions.md) object which points to the app and configures install-time options. The function returns a promise containing a [`Player`](https://github.com/holochain-open-dev/tryorama/blob/main/docs/tryorama.player.md) object, which is a container for:
