...
You'll also need to install a few packages if you want to run two dev tools, `hc spin` and `hc launc`, which start your app's back end and open its GUI in Electron or Tauri webviews:
