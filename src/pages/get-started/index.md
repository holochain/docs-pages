...
tocData:
  ...
  - text: "5. Zero to built: creating a forum app"
    ...
    - text: 5.7. Scaffold a collection
      href: 5-7-scaffold-a-collection
    - text: 5.8. Integrate the generated UI elements
      href: 5-8-integrate-the-generated-ui-elements
...
For this next field we want to create a field that will help us associate each particular comment to the post that it is commenting on.  To do this we want to store a reference to the post as part of the comment entry.
...
After hitting <kbd>Enter</kbd>, we should see:
...
### 5.8. Integrate the generated UI elements
