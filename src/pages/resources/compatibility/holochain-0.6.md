...
!!! info Recommended
Holochain 0.6 is currently the **recommended** version for general use.
!!!
...
|---------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| [`holochain` core library and conductor binary](https://github.com/holochain/holochain)           | [0.6.0](https://crates.io/crates/holochain/0.6.0)                                                                  |
...
| [`hdk` library](https://crates.io/crates/hdk)                                                     | [0.6.0](https://crates.io/crates/hdk/0.6.0)                                                                        |
| [`hdi` library](https://crates.io/crates/hdi)                                                     | [0.7.0](https://crates.io/crates/hdi/0.7.0)                                                                        |
| [JavaScript client library](https://github.com/holochain/holochain-client-js)                     | [0.20.0](https://www.npmjs.com/package/@holochain/client/v/0.20.0)                                                 |
| [Rust client library](https://github.com/holochain/holochain/tree/main/crates/client)             | [0.8.0](https://crates.io/crates/holochain_client/0.8.0)                                                           |
| [Tryorama testing library](https://github.com/holochain/tryorama)                                 | [0.19.0](https://www.npmjs.com/package/@holochain/tryorama/v/0.19.0)                                               |
| [`kangaroo-electron` app template repo](https://github.com/holochain/kangaroo-electron)           | [commit `3f4f063`](https://github.com/holochain/kangaroo-electron/commit/3f4f0630a31f5b271052ff822bf5670b1dc42301) |
