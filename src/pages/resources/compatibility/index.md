...
* The [lair keystore](https://github.com/holochain/lair), [Kitsune2 bootstrap server](https://github.com/holochain/kitsune2/tree/main/crates/bootstrap_srv), [Rust](https://github.com/holochain/holochain/tree/main/crates/client) and [JavaScript](https://github.com/holochain/holochain-client-js) clients, [Tryorama library](https://github.com/holochain-open-dev/tryorama), and [`kangaroo-electron` app template repo](https://github.com/holochain/kangaroo-electron) have their own version number sequences, but almost always advance by one for every new Holochain release series. For example, if JavaScript client 0.19.x is compatible with Holochain 0.5, then JavaScript client 0.20.x will be compatible with Holochain 0.6. (See the [note above](#0-6-1-tryorama-playground-deprecation) about about Tryorama being deprecated.)
