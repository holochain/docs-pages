...
* **We recommend using the [scaffolding tool](/get-started/2-forum-app-tutorial/) to create an app**, because it'll ensure that all version numbers are in sync.
* **As of Holochain 0.6.1, Tryorama and the Playground are no longer officially supported and have been removed from the Holonix developer environment.** {#0-6-1-tryorama-playground-deprecation}
...
* From Holochain 0.5 onwards, the most significant number of the [scaffolding](https://github.com/holochain/scaffolding/), [`hc-spin`](https://github.com/holochain/hc-spin), and [playground](https://github.com/darksoil-studio/holochain-playground) CLI tools is the same as that of the core library, but multiplied by 100. For instance, for Holochain 0.6, use version 0.600.x of these tools. (See the [note above](#0-6-1-tryorama-playground-deprecation) about Playground being deprecated.)
* The [lair keystore](https://github.com/holochain/lair), [Kitsune2 bootstrap server](https://github.com/holochain/kitsune2/tree/main/crates/bootstrap_srv), [Rust](https://github.com/holochain/holochain/tree/main/crates/client) and [JavaScript](https://github.com/holochain/holochain-client-js) clients, [Tryorama library](https://github.com/holochain-open-dev/tryorama), and [`kangaroo-electron` app template repo](https://github.com/holochain/kangaroo-electron) have their own version number sequences, but almost always advance by one for every new Holochain release series. For example, if JavaScript client 0.19.x is compatible with Holochain 0.5, then JavaScript client 0.20.x will be compatible with Holochain 0.6. (See the [note above](#0-6-1-tryorama-playground-deprecation) about Tryorama being deprecated.)
