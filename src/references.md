...
* **`hc`** is an all-purpose developer tool that:
    ...
    * (more to come)
* **`lair-keystore`** is Holochain's [secret lair private keystore](https://github.com/holochain/lair). Use this command for initialization, configuration, and running of a Lair keystore.
